...
BOT_NAME = getenv("BOT_NAME", "PyTgMusicBot")
...
OWNER_USERNAME = getenv("OWNER_USERNAME", "AttitudeKing_vj")
ALIVE_NAME = getenv("ALIVE_NAME", "PyTgMusic")
BOT_USERNAME = getenv("BOT_USERNAME", "Pytgs_MusicBot")
OWNER_ID = getenv("OWNER_ID", "1669178360")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Zaid2_Assistant")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "PyTgMusicSupport")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "PyTgMusicUpdates")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ItsVijayxd/Zaid-Vc-Player")
